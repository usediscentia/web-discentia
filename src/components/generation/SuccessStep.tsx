...
export default function SuccessStep({ cardCount, subtitle, badge, onAutoClose }: SuccessStepProps) {
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        {subtitle ?? (cardCount === 1 ? "card added to your deck" : "cards added to your deck")}
      </motion.p>
